...
def startingEvent():
    ...
    # Start Button
    Shapes.buttons.append(Button.Button(Vector2(390,330),Vector2(500,120),[28, 165, 179],5,[0,0,0], "Start Program",[0,0,0], Vector2(5,5),6, 70))
...
def graphingMenu():
    ...
    # Graphing Rectangle
    Shapes.borderRectangles.append(ShapeRectBorder.RectBorder(Vector2(290,140),Vector2(800,500),[190,190,190],10,[0,0,0]))
