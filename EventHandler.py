...
def rollCredits():
    ...
    settingsButton.addOnClickedCall( lambda : State.state.changeState(State.settingsMenu))
...
def mainMenu():
    ...
    startButton.addOnClickedCall( lambda : State.state.changeState(State.graphingMenu))

    # Credits Buttonin
    creditsButton = Button.Button(Vector2(580,530),Vector2(120,60),[125,125,125],5,[0,0,0], "Credits",[0,0,0], Vector2(5,5), 30)
    creditsButton.addOnClickedCall( lambda : State.state.changeState(State.creditsMenu))
